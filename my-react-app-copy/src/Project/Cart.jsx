        ...
        <div className="card mb-3 p-3 shadow" key={item.id}>
          <div className="row align-items-center g-3">
            <div className="col-md-3 text-center">
              <img src={item.myimg2} alt={item.titlee2} style={{ maxHeight: "120px" }} />
            </div>
            ...
            <div className="col-md-3 d-flex align-items-center">
              <button className="btn btn-outline-secondary" onClick={() => decreaseQty(item)}>−</button>
              <span className="mx-3 fw-bold">{item.qty}</span>
              <button className="btn btn-outline-secondary" onClick={() => increaseQty(item)}>+</button>
            </div>
